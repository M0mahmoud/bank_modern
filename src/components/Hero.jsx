  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-16 px-6 `}>
      <div className="flex flex-row items-center py-[6px] px-6 bg-discount-gradient rounded-[10px] mb-2">
        <img src={discount} alt="SMALL ICON" className="w-[32px] h-[32px]" />
        <p className={`${styles.paragraph} ml-2`}>
          <span className="text-white ">20$ </span> Discount For
          <span className="text-white "> 1 Mon </span> Account
        </p>
      </div>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        veniam cum nisi pariatur molestiae eius vel vitae voluptate, optio .
      </p>
    </div>
